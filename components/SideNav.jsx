  ...
  function showNav()
{
 ...
 return (
  <>
  <ArrowRightIcon id='triggerArrow' onClick={showNav} className='w-7 text-black bg-white rounded-r-full hover:text-cyan-700 hover:border-2 border-cyan-600 cursor-pointer' />
    <div id='nav' className={cl.nav}>
      <XCircleIcon onClick={showNav} className='w-6 ml-2 mb-3 hover:text-cyan-400 cursor-pointer' />
        <ul>
